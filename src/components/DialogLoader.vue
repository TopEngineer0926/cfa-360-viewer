<template>
  <div>
    ...
    >
      {{ snackbar.message }}
      <!-- <v-btn text :color="snackbar.close.color" @click="hideSnackbar">{{ snackbar.close.text }}</v-btn> -->

      <template v-slot:action="{ attrs }">
        <v-btn icon color="white" v-bind="attrs" @click="hideSnackbar">
...
<script>
/**
 * https://github.com/tripflex/VuetifyDialogLoader
 *
